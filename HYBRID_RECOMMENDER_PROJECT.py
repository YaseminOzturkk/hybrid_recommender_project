...
user_movie_df # bu dataframe'in indexinde userid'ler var
# Bu dataframe'deki Userid'ler içerisinden az önce seçtiğimiz random_user'ı seçmemiz lazım
...
def item_based_recommender(movie_name, user_movie_df):
    ...
    return user_movie_df.corrwith(movie).sort_values(ascending=False).head()
